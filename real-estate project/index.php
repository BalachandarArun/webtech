...
<head>
  ...
  <title> Real homie- Choose your dream place</title>
  <script src="js/script.js"></script>
  <!-- 
    - favicon
  -->
  <link rel="shortcut icon" href="/real-estate project/" type="image/svg+xml">
...
<body id="top">
  ...
  <header class="header" data-header>
    <div class="container">
      ...
      <a href="#" class="logo">
        <ion-icon name="business-outline"></ion-icon> Real homie
      </a>
      ...
      <nav class="navbar container" data-navbar>
        <ul class="navbar-list">
          ...
          <li>
            <a href="selling.html" class="navbar-link" data-nav-link>Sell</a>
          </li>
              ...
              <ul class="property-list">
                <li>
                  <div class="property-card">
                    ...
                    <?php
                      echo '<img src="data:image;base64,'.base64_encode($row["propimage"]).'" class="img-cover" loading="lazy" ">'
                    ?>
                    <!-- <img src="" width="800" height="533" loading="lazy"
                        alt="710 BOYD DR, Unit #1102, Baton Rouge, LA 70808, USA" class="img-cover"> -->
                    </figure>
                    ...
                    <div class="card-content">
                      ...
                      <h3 class="h3">
                          <?php
                              echo '<a href="#" class="card-title">'.$desc.'</a>';
                          ?>
                        <!-- <a href="#" class="card-title">710 BOYD DR, Unit #1102, Baton Rouge, LA 70808, USA</a> -->
                      </h3>
                      ...
                      <ul class="card-list">
                        ...
                        <li class="card-item">
                          ...
                          <?php
                            echo '<span class="item-text">'.$srft.' sqf</span>';
                          ?>
                          <!-- <span class="item-text">8000sqf</span> -->
                        </li>
                        ...
                        <li class="card-item">
                          ...
                          <?php
                            echo '<span class="item-text">'.$beds.' Beds</span>';
                          ?>
                          <!-- <span class="item-text">4 Beds</span> -->
                        </li>
                        ...
                        <li class="card-item">
                          ...
                          <?php
                            echo '<span class="item-text">'.$baths.' Baths</span>';
                          ?>
                          <!-- <span class="item-text">4 Baths</span> -->
                        </li>
                      ...
                      <div class="card-meta">
                        ...
                        <div>
                          <span class="meta-title">Price</span>
                          <?php
                            echo '<span class="meta-text">$'.$price.'</span>';
                          ?>
                          <!-- <span class="meta-text">$5000</span> -->
                        </div>
                      </div>
  ...
  <footer class="footer">
    ...
    <div class="footer-bottom">
      <div class="container">
        ...
        <p class="copyright">
          &copy; 2022  Real homie. All Right Reserved by <a href="#" class="copyright-link">Bala</a>.
        </p>
